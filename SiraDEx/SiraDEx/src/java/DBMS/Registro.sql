...
INSERT INTO usuario (usbid,password,rol,tipo,nombres,apellidos,telefono,email) VALUES ('05-38978', 'alejandro', 'estudiante', 1, 'Alejandro', 'Tarazona', '04121341842', '05-38978@usb.ve');
INSERT INTO usuario (usbid,password,rol,tipo,nombres,apellidos,telefono,email) VALUES ('05-38199', '123456', 'WM', 2, 'Jorge', 'García', '04141360451', '05-38199@usb.ve');
INSERT INTO usuario (usbid,password,rol,tipo,nombres,apellidos,telefono,email) VALUES ('07-41618', 'diana', 'estudiante', 1, 'Diana', 'Vainberg', '04126053552', '07-41618@usb.ve');
INSERT INTO usuario (usbid,password,rol,tipo,nombres,apellidos,telefono,email) VALUES ('jf', 'jf', 'estudiante', 1, 'Jose', 'Fernandez', '04125555555', 'jf@usb.ve');
...
INSERT INTO usuario (usbid,password,rol,tipo,nombres,apellidos,telefono,email) VALUES ('99-10000', 'pedrog', 'empleado',2, 'Pedro', 'Gomez',  null, '07-10000@usb.ve');
...
--INSERT INTO campo_catalogo (id_cat, nombre_campo, tipo_campo) VALUES (4, 'Id carrera', 'Texto');

--      Campos de departamentos
--INSERT INTO campo_catalogo (id_cat, nombre_campo, tipo_campo) VALUES (5, 'Nombre departamento', 'Texto');
--INSERT INTO campo_catalogo (id_cat, nombre_campo, tipo_campo) VALUES (5, 'Id jefe_dpto', 'Texto');
...
INSERT INTO valor_catalogo (id_campo, id_elemento, valor) VALUES (1,1,'Unidad de Comunicación, Imagen y Divulgación');
INSERT INTO valor_catalogo (id_campo, id_elemento, valor) VALUES (1,2,'Unidad de Apoyo Administrativo');
INSERT INTO valor_catalogo (id_campo, id_elemento, valor) VALUES (1,3,'Unidad de Participación y Acción Social');
INSERT INTO valor_catalogo (id_campo, id_elemento, valor) VALUES (1,4,'Coordinación de Educacion Permanente');
INSERT INTO valor_catalogo (id_campo, id_elemento, valor) VALUES (1,5,'Coordinación de Cooperación Técnica');
INSERT INTO valor_catalogo (id_campo, id_elemento, valor) VALUES (1,6,'Coordinación de Igualdad de Oportunidades');
INSERT INTO valor_catalogo (id_campo, id_elemento, valor) VALUES (1,7,'Coordinación de Formación Complementaria General');
INSERT INTO valor_catalogo (id_campo, id_elemento, valor) VALUES (1,8,'Coordinación de Extensión de la sede del Litoral');
INSERT INTO valor_catalogo (id_campo, id_elemento, valor) VALUES (1,9,'Coordinación de Emprendimiento y Seguimiento al Egresado');


--      Valores de los emails(porque no sabemos los id) de los coordinadores o jefes de las dep del DEx
INSERT INTO valor_catalogo (id_campo, id_elemento, valor) VALUES (2,1,'mavivas@usb.ve');
INSERT INTO valor_catalogo (id_campo, id_elemento, valor) VALUES (2,2,'bjlugo@usb.ve');
INSERT INTO valor_catalogo (id_campo, id_elemento, valor) VALUES (2,3,'econes@usb.ve');
INSERT INTO valor_catalogo (id_campo, id_elemento, valor) VALUES (2,4,'vurbina@usb.ve');
INSERT INTO valor_catalogo (id_campo, id_elemento, valor) VALUES (2,5,'kdoming@usb.ve');
INSERT INTO valor_catalogo (id_campo, id_elemento, valor) VALUES (2,6,'eabdala@usb.ve');
INSERT INTO valor_catalogo (id_campo, id_elemento, valor) VALUES (2,7,'grincon@usb.ve');
INSERT INTO valor_catalogo (id_campo, id_elemento, valor) VALUES (2,8,'mclaudeville@usb.ve');
INSERT INTO valor_catalogo (id_campo, id_elemento, valor) VALUES (2,9,'vdimperio@usb.ve');

--	Valores de los nombre de los programas asumiendo que 3 es el codigo de "Nombre de Programa"
INSERT INTO valor_catalogo (id_campo, id_elemento, valor) VALUES (3,10,'Educacion Permanente');
INSERT INTO valor_catalogo (id_campo, id_elemento, valor) VALUES (3,11,'Acción Social y Desarrollo Comunitario');
INSERT INTO valor_catalogo (id_campo, id_elemento, valor) VALUES (3,12,'Cooperación Técnica');
INSERT INTO valor_catalogo (id_campo, id_elemento, valor) VALUES (3,13,'El fomento y la proyección artística, cultural y deportiva');
INSERT INTO valor_catalogo (id_campo, id_elemento, valor) VALUES (3,14,'Divulgación y promoción del quehacer universitario');
INSERT INTO valor_catalogo (id_campo, id_elemento, valor) VALUES (3,15,'Igualdad de Oportunidades');
INSERT INTO valor_catalogo (id_campo, id_elemento, valor) VALUES (3,16,'Emprendimiento y Seguimiento de Egresados');
